...
- API version: 0.0.1
  - Build date: 2023-12-14T02:14:43.301373700+01:00[Europe/Berlin]
...
------------ | ------------- | ------------- | -------------
*UserApi* | [**getUserById**](docs/UserApi.md#getUserById) | **GET** /user/{id} | Retrieves User by ID
